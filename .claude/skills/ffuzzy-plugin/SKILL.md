...
>   **Dart 公开 API 用 `Fuzzy*` 前缀**(2026-06-27 从 `Ffz*` 改名):`FuzzyCorpus`、`FuzzyHit`、
>   `FuzzyMode`/`FuzzyCase`/`FuzzyNorm`、`FuzzyKeyKind`、`FuzzyKey`、`FuzzyException`、`FuzzyCrash`、
>   顶层函数 `fuzzyCodepointToUtf16`。
